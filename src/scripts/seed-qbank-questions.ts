...
async function seedQBankQuestions() {
    ...
    try {
        ...
        try {
            const result = await db.select({ value: sql`1` }).from(schema.users).limit(1);
        ...
        if (!qbank) {
            ...
            const newQbanks = await db.insert(schema.questionBanks).values({
        ...
        const classicQuestions = [
            {
                ...
                correctAnswer: 'b',
                explanation: 'Diaphoresis (sweating) is a common sign of hypoglycemia, along with tachycardia, tremors, and confusion.',
                difficulty: 'medium',
            ...
            },
            {
                ...
                correctAnswer: 'a',
                explanation: 'Patients with COPD rely on hypoxic drive; high oxygen levels can suppress breathing. 1-2 L/min is standard.',
                difficulty: 'medium',
                subject: 'Adult Health',
                testType: 'classic'
            },
            {
                ...
                correctAnswer: 'b',
                explanation: 'Hypokalemia often causes T-wave inversion and U waves. Hyperkalemia causes peaked T-waves.',
                difficulty: 'hard',
                subject: 'Physiology',
                testType: 'classic'
            },
            {
                question: 'What is the priority nursing intervention for a patient with a suspected myocardial infarction?',
                questionType: 'multiple_choice',
                options: JSON.stringify([
                ...
                correctAnswer: 'b',
                explanation: 'MONA protocol: Morphine, Oxygen, Nitroglycerin, Aspirin. Oxygen is usually the first priority to improve myocardial oxygenation.',
                difficulty: 'medium',
            ...
            },
            {
                ...
                correctAnswer: 'b',
                explanation: 'Protamine Sulfate reverses the effects of heparin. Vitamin K is for Warfarin.',
                difficulty: 'easy',
                subject: 'Pharmacology',
                testType: 'classic'
            },
            {
                question: 'A patient is prescribed Lasix (furosemide). Which food should the nurse encourage?',
                questionType: 'multiple_choice',
                options: JSON.stringify([
                    { id: 'a', text: 'Bananas' },
                    { id: 'b', text: 'Cheese' },
            ...
            {
                question: 'The nurse assesses a patient with a cast for compartment syndrome. Which is a late sign?',
                questionType: 'multiple_choice',
                options: JSON.stringify([
                    { id: 'a', text: 'Pain' },
                    { id: 'b', text: 'Pallor' },
                ...
                correctAnswer: 'c',
                explanation: 'Pulselessness is a late and ominous sign of compartment syndrome. Pain is usually the first sign.',
                difficulty: 'hard',
                subject: 'Med-Surg',
                testType: 'classic'
            }
        ...
        const ngnQuestions = [
            {
                ...
                explanation: 'Signs of increased ICP in infants include high-pitched cry, bulging fontanels, increased head circumference, and irritability. Sunken eyes are a sign of dehydration.',
                difficulty: 'hard',
                subject: 'Pediatrics',
                testType: 'ngn'
            },
            {
                question: 'A client with heart failure is prescribed Digoxin. Which findings indicate toxicity? Select all that apply.',
                questionType: 'sata',
                options: JSON.stringify([
                    { id: 'a', text: 'Bradycardia' },
                ...
                explanation: 'Digoxin toxicity causes bradycardia, visual disturbances (yellow/green halos), and GI symptoms like nausea/vomiting.',
                difficulty: 'hard',
                subject: 'Pharmacology',
                testType: 'ngn'
            },
            {
                ...
                correctAnswer: JSON.stringify(['a', 'b', 'c']),
                explanation: 'MAOIs require a tyramine-free diet to prevent hypertensive crisis. Aged cheese, cured meats, and red wine contain high tyramine.',
                difficulty: 'medium',
                subject: 'Mental Health',
                testType: 'ngn'
            },
            {
                question: 'Case Study: 65yo Male with COPD exacerbation. Select the appropriate interventions.',
                questionType: 'sata',
                options: JSON.stringify([
                ...
                explanation: 'COPD management includes bronchodilators, corticosteroids, and pursed-lip breathing. High-flow O2 can be dangerous, and upright positioning is better than supine.',
                difficulty: 'hard',
                subject: 'Med-Surg',
                testType: 'ngn'
            },
            {
                question: 'Which of the following are risk factors for Deep Vein Thrombosis (DVT)? Select all that apply.',
                questionType: 'sata',
                options: JSON.stringify([
                ...
                explanation: 'Virchow\'s Triad: Stasis (immobility), Endothelial injury (surgery, smoking), Hypercoagulability (OCPs). Low BP is not a direct risk factor.',
                difficulty: 'medium',
                subject: 'Med-Surg',
                testType: 'ngn'
            },
            {
                question: 'Select the correct steps for insulin mixing (Regular and NPH). Select all that apply in order.',
                questionType: 'sata',
                options: JSON.stringify([
                ...
                correctAnswer: JSON.stringify(['a', 'b', 'c', 'd']),
                explanation: 'Mnemonic: RN (Regular before NPH). Air into NPH, Air into Regular, Draw Regular, Draw NPH.',
                difficulty: 'hard',
                subject: 'Pharmacology',
                testType: 'ngn'
            },
            {
                question: 'Which assessment findings are consistent with Cushing\'s Syndrome? Select all that apply.',
                questionType: 'sata',
                options: JSON.stringify([
                    { id: 'a', text: 'Moon face' },
                ...
                explanation: 'Cushing\'s (excess cortisol) causes moon face, buffalo hump, hyperglycemia, hypertension (not hypotension), and weight gain (not loss).',
                difficulty: 'medium',
                subject: 'Endocrine',
                testType: 'ngn'
            },
            {
                question: 'Select the appropriate nursing actions for a patient having a tonic-clonic seizure. Select all that apply.',
                questionType: 'sata',
                options: JSON.stringify([
                ...
                explanation: 'Safety first: Turn to side (aspiration), loosen clothing, time it. NEVER insert objects or restrain.',
                difficulty: 'medium',
                subject: 'Neurology',
                testType: 'ngn'
            },
            {
                ...
                explanation: 'Live vaccines (MMR, Varicella, Nasal Flu) are contraindicated. Inactivated Flu and Tdap are recommended.',
                difficulty: 'hard',
                subject: 'Maternity',
                testType: 'ngn'
            },
            {
                ...
                correctAnswer: JSON.stringify(['a', 'b', 'c', 'e']),
                explanation: 'Fine tremors are a side effect. Coarse tremors, confusion, ataxia, and polyuria indicate toxicity (>1.5 mEq/L).',
                difficulty: 'hard',
                subject: 'Mental Health',
                testType: 'ngn'
            }
