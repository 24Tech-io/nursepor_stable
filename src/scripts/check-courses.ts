process.env.DATABASE_URL = 'postgresql://neondb_owner:npg_pt4xwuEAB7MNOQ3yoFvdHBItigGcCmT@ep-lively-glitter-a5214041-pooler.us-east-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require';
