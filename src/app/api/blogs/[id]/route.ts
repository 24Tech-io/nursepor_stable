  ...
  try {
    ...
    if (data.tags !== undefined || data.excerpt !== undefined || data.featured !== undefined) {
      ...
      const metadata = {
        ...
        seoTitle: data.seoTitle !== undefined ? data.seoTitle : existingMetadata.seoTitle || data.title || existing[0].title,
        seoDescription: data.seoDescription !== undefined ? data.seoDescription : existingMetadata.seoDescription || '',
        scheduledPublish: data.scheduledPublish !== undefined ? data.scheduledPublish : existingMetadata.scheduledPublish || null,
        readingTime: data.readingTime !== undefined ? data.readingTime : existingMetadata.readingTime || null,
