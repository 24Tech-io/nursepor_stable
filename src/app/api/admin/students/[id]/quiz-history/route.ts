...
/**
 * GET - Fetch all quiz/test history for a student (admin view)
 * This endpoint uses the same unified logic as /api/analysis/quiz-history
...
export async function GET(
  ...
  try {
    ...
    // Fetch Q-Bank test attempts with detailed analysis (same as unified endpoint)
    ...
    // Fetch course quiz attempts with detailed analysis (same as unified endpoint)
    ...
    // Format Q-Bank tests with comprehensive analysis (same as unified endpoint)
    ...
    // Format quiz attempts with comprehensive analysis (same as unified endpoint)
    ...
    // Calculate comprehensive statistics (same as unified endpoint)
    ...
    logger.error('Get student quiz history error:', error);
    return NextResponse.json(
      { message: 'Failed to fetch quiz history', error: error.message },
      { status: 500 }
    );
  }
}
