            ...
            try {
                ...
                if (existingProgress.length > 0) {
                    ...
                    if (!watchedVideos.includes(parseInt(chapterId))) {
                        ...
                        console.log(`✅ Video progress synced: Added chapter ${chapterId} to watched videos for course ${courseId}`);
                    }
                } else {
                    ...
                    console.log(`✅ Created studentProgress and synced video progress for course ${courseId}`);
                }
            } catch (error) {
