...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-8">
      <div className="bg-gradient-to-br from-purple-700 via-indigo-700 to-blue-800 rounded-3xl shadow-2xl p-10 text-white relative overflow-hidden border border-purple-500/20">
        ...
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-blue-400/20 to-transparent rounded-full blur-3xl -ml-40 -mb-40" />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-indigo-500/10 rounded-full blur-2xl" />
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p className="text-sm font-semibold text-purple-200 uppercase tracking-wider mb-1">Admin Portal</p>
                <h1 className="text-5xl font-extrabold mb-2 bg-gradient-to-r from-white to-purple-100 bg-clip-text text-transparent">
                  Welcome back, Admin
                </h1>
                <p className="text-xl text-purple-100 font-medium">{user?.name || 'Administrator'}</p>
              </div>
            </div>
            <p className="text-purple-200/90 text-base mt-4 flex items-center gap-2">
