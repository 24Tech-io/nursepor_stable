        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
                {recommendations.slice(0, 5).map((rec) => (
                    <div
                        key={rec.courseId}
                        onClick={() => router.push(`/student/courses/${rec.courseId}/chapters/${rec.nextChapter.id}`)}
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2 mt-1 text-sm text-gray-600">
                                    ...
                                    <span>{rec.nextChapter.moduleTitle}: {rec.nextChapter.title}</span>
                                </div>
                            ...
                            {/* Arrow */}
                            <ChevronRight className="text-gray-400 group-hover:text-purple-600 transition" size={24} />
                        </div>
                    </div>
                ))}
            </div>
